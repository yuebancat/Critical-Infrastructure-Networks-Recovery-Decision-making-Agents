...
def network_assessment_by_diameter(global_json_path: str):
    ...
    output_json_path = 'network_assessment_by_diameter.json'
    ...
    file_paths['network_assessment_by_diameter'] = output_json_path
